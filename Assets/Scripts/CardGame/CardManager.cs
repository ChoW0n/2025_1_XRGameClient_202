...
public class CardManager : MonoBehaviour
{
    ...
    public void DrawCard()
    {
        ...
        Debug.Log("카드를 드로우 했습니다. : " + cardData.cardName + " (손 패 : " + handCards.Count + "/6");
    }
    ...
    public void DiscardCard(int handIndex)       //카드 버리기(디스 카드)
    {
        ...
        {
            Debug.Log("유효하지 않은 카드 인덱스 입니다! " + handIndex + "," + handCards.Count);
            return;
        }
