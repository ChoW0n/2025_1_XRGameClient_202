...
public class DamageEffectManager : MonoBehaviour
{
    ...
    [SerializeField] private Canvas uiCanvas;           //UI 캔바스 참조
    ...
    public void ShowDamage(Vector3 position, int amount, bool isCritical = false)       //데미지 함수
    {
        ...
        Color color = isCritical ? new Color(1.0f, 0.8f, 0.0f):
    ...
    {
        string text = amount.ToString();
        Color color = isCritical ? new Color(0.4f, 1.0f, 0.4f) :
    ...
    public void ShowStatusEffect(Vector3 position, string effectName)
    {
        ...
        switch (effectName.ToLower())
        {
            ...
            case "stun":
                ...
                break;
            default:
                color = new Color(1.0f, 1.0f, 1.0f);        //보라색
                break;
        }
